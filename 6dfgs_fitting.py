...
def bel_fitting(w, f, z, fig_path):
    ...
    # f, fs = f - continuum_fitting(w, f, 100), False   # Uncomment this to use the continuum fitting tool for tricky spectra
    ...
    q.Fit(name=None, nsmooth=1, deredden=False, reject_badpix=False, wave_range=None, redshift=False,
          Fe_uv_op=False, poly=fs, BC=True, initial_guess=None, MC=p1[0], MC_conti=False, decomposition_host=fs,
